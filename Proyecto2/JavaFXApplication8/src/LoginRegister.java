...
public class LoginRegister extends Application {
    ...
    private Image img = new Image("file:src/images/FondoLogin.png");
    ...
    public void start(Stage primaryStage) throws Exception {
       ...
       primaryStage.getIcons().add(new Image("file:src/images/icono.png"));
        Pane root = new Pane();
        ...
        private void enviarCredenciales() {
            try {
                ...
                if (respuesta.equals("OK")) {
                    if (clienteApp == null) {
                        clienteApp = new AppCliente(campoUsuario.getText());
                    }
